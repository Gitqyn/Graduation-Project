...
<body>
    ...
    <div class="footer warpper clearfix">
        <ul>
            ...
            <li>
                <a href="./kuaixun.html">社团快讯</a>
            </li>
            <li>
                <a href="fengcai.html">社团风采</a>
            </li>
            
            <li class="a_hot2">
                <a href="./zhidu.html">规章制度
                    <i class="m_hot"></i>
                </a>
            </li>
            <li>
                <a href="../JSP/login.jsp">申请社团</a>
            </li>
            <div class="app">
                <a href="">
    ...
    <div class="b ">
        <div class="main warpper">
            <div class="menu ">
                <ul >
                    <li class="l_hot01">
                        <a href="fengcai.html">专业学术类
                            <i class="m_hot"></i>
                        </a>

                    </li>
                    <li class="l_hot02">
                        <a href="fengcai.html">艺术兴趣类
                            <i class="m_hot"></i>
                        </a>
                        
                    </li>
                    <li class="l_hot02">
                        <a href="fengcai.html">体育健身类
                            <i class="m_hot"></i>
                        </a>
                       
                    </li>
                    <li>
                        <a href="fengcai.html">公益服务类</a>
                    </li>
                    <li>
                        <a href="fengcai.html">中外联合类</a>
                    </li>
                    <li>
                        <a href="fengcai.html">职业素养类</a>
                    </li>
                    <li>
                        <a href="fengcai.html">军事政治类</a>
                    </li>
                    <li >
                        <a href="fengcai.html">其他
